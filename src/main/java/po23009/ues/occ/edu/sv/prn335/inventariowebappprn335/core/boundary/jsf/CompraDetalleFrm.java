...
@Named
@ViewScoped
public class CompraDetalleFrm extends DefaultFrm<CompraDetalle, UUID> implements Serializable {
    @Inject
    ...
    @Override
    protected InventarioDefaultDataAccess<CompraDetalle, UUID> getDAO() {
